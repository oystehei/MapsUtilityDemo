...
*  [Xamarin.Android.Support.v4 (revision 19.0.1)](http://components.xamarin.com/view/xamandroidsupportv4-18) assembly. This is an updated version of `Mono.Android.Support.v4` and is not compatible with the old one. Applications can no longer reference or use `Mono.Android.Support.v4`.
